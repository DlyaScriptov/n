...
a21="  11. Распакован архив с сайтом"
# ........................................

# 4.2. Распаковываем архив с базой данных
unzip /home/download/TestDB.zip
a22="  12. Распакован архив с базой данных"
# ==================================================================
...
a23="  13. Очистка файла appsettings.json и заполнение его актуальным текстом"
# ........................................

# 5.2. Переименовываем каталог с сайтом
mv update-school-sample.nbics.net $nbicsNameDomain
a24="  14. Переименован каталог с сайтом (назначено ему такое же имя, как у домена)"
# ==================================================================
...
a25="  15. Каталог с сайтом скопирован в /var/www/html/"
# ........................................

# 6.2. Копируем базу данных
cp TestDB.bak /var/opt/db/BACKUP/
a26="  16. База данных скопирована в /var/opt/db/BACKUP/"
# ........................................
...
rm -rf $nbicsNameDomain
rm -f TestDB.bak
a27="  17. Распакованные каталог с сайтом и база данных удалены из /home/download/"
