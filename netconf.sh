...
sed -i -e "8a|      addresses: [$netconfIpMask]|g"  /etc/netplan/01-netcfg.yaml
sed -i -e "9a|      gateway4: $netconfGateway|g"  /etc/netplan/01-netcfg.yaml
sed -i -e "10a|      nameservers:"  /etc/netplan/01-netcfg.yaml
sed -i -e "11a|        addresses: [$netconfDns]|g"  /etc/netplan/01-netcfg.yaml
